...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-mmj3fto.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-mmj3fto.containers.anotherwebservice.com/
...
```
git clone git@github.com:paumor5/container-mmj3fto.git
cd container-mmj3fto
```
...
```
docker attach container-mmj3fto
```
